...
const TOTE_PRICES: Record<string, number> = { Standard: 30, Large: 35 };
...
export const collectionProducts: Product[] = [
  ...
  },
  {
    ...
    image: '',
    images: [],
    description: 'T-shirt featuring the Phnom Penh painting. Coming soon.',
    colors: ['White', 'Black', 'Beige'],
    sizes: TEE_SIZES,
    inStock: false,
  },
  {
    ...
    image: '',
    images: [],
    description: 'Sturdy canvas tote bag featuring the Phnom Penh painting. Coming soon.',
    colors: ['Beige', 'Black', 'White'],
    sizes: TOTE_SIZES,
    sizePrice: TOTE_PRICES,
    inStock: false,
